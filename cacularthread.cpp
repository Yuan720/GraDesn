...
void CacularThread::SigmaValuesSolve(int steelId,bool beamType, float x)
{
    ...
    vector<float> res;
    res.push_back(beamtoSolve.steelPaths[steelId-1].getSigma_l1(x));
    res.push_back(beamtoSolve.steelPaths[steelId-1].getSigma_l2(x));
    res.push_back(beamtoSolve.getSigma_l4(Ap));
    res.push_back(beamtoSolve.getSigma_L_I(x,Ap));
    res.push_back(beamtoSolve.getSigma_l5(Ap));
    res.push_back(beamtoSolve.getSigma_l6(Ap));
    res.push_back(beamtoSolve.getSigma_L_II(Ap));
    res.push_back(beamtoSolve.getSigma_P_I(x,Ap));
    res.push_back(beamtoSolve.getSigma_P_II(x,Ap));
    res.push_back(beamtoSolve.getAveSigma_l1(x));
    res.push_back(beamtoSolve.getAveSigma_l2(x));
